...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TTabCom*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TTabCom", ::TTabCom::Class_Version(), "TTabCom.h", 52,
...
TClass *TRint::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TRint*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TTabCom*)0x0)->GetClass(); }
   return fgIsA;
}
...
""
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libRint",
        ...
        TriggerDictionaryInitialization_libRint_Impl, {}, classesHeaders, /*hasCxxModule*/true);
      isInitialized = true;
    }
  }
