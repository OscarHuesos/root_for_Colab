...
#define R__DICTIONARY_FILENAME G__complexDict
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::complex<long>*)
   {
      ...
      ::ROOT::AddClassAlternate("complex<long>","std::complex<long>");
      return &instance;
   }
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::complex<int>*)
   {
      ...
      ::ROOT::AddClassAlternate("complex<int>","std::complex<int>");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::complex<float>*)
   {
      ...
      ::ROOT::AddClassAlternate("complex<float>","std::complex<float>");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::complex<double>*)
   {
      ...
      ::ROOT::AddClassAlternate("complex<double>","std::complex<double>");
      return &instance;
   }
   // Static variable to force the class initialization
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libcomplexDict",
        ...
        TriggerDictionaryInitialization_libcomplexDict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
