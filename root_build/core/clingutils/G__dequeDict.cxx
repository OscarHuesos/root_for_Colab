...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const deque<void*>*)
   {
      ...
      ::ROOT::AddClassAlternate("deque<void*>","std::deque<void*, std::allocator<void*> >");
      return &instance;
   }
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const deque<long>*)
   {
      ...
      ::ROOT::AddClassAlternate("deque<long>","std::deque<long, std::allocator<long> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const deque<int>*)
   {
      ...
      ::ROOT::AddClassAlternate("deque<int>","std::deque<int, std::allocator<int> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const deque<float>*)
   {
      ...
      ::ROOT::AddClassAlternate("deque<float>","std::deque<float, std::allocator<float> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const deque<double>*)
   {
      ...
      ::ROOT::AddClassAlternate("deque<double>","std::deque<double, std::allocator<double> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const deque<char*>*)
   {
      ...
      ::ROOT::AddClassAlternate("deque<char*>","std::deque<char*, std::allocator<char*> >");
      return &instance;
   }
   // Static variable to force the class initialization
