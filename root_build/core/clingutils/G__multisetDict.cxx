...
#define R__DICTIONARY_FILENAME G__multisetDict
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const multiset<void*>*)
   {
      ...
      ::ROOT::AddClassAlternate("multiset<void*>","std::multiset<void*, std::less<void*>, std::allocator<void*> >");
      return &instance;
   }
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const multiset<string>*)
   {
      ...
      ::ROOT::AddClassAlternate("multiset<string>","std::multiset<std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >, std::less<std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > >, std::allocator<std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const multiset<long>*)
   {
      ...
      ::ROOT::AddClassAlternate("multiset<long>","std::multiset<long, std::less<long>, std::allocator<long> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const multiset<int>*)
   {
      ...
      ::ROOT::AddClassAlternate("multiset<int>","std::multiset<int, std::less<int>, std::allocator<int> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const multiset<float>*)
   {
      ...
      ::ROOT::AddClassAlternate("multiset<float>","std::multiset<float, std::less<float>, std::allocator<float> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const multiset<double>*)
   {
      ...
      ::ROOT::AddClassAlternate("multiset<double>","std::multiset<double, std::less<double>, std::allocator<double> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const multiset<char*>*)
   {
      ...
      ::ROOT::AddClassAlternate("multiset<char*>","std::multiset<char*, std::less<char*>, std::allocator<char*> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libmultisetDict",
        ...
        TriggerDictionaryInitialization_libmultisetDict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
