...
#define R__DICTIONARY_FILENAME G__forward_listDict
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const forward_list<void*>*)
   {
      ...
      ::ROOT::AddClassAlternate("forward_list<void*>","std::forward_list<void*, std::allocator<void*> >");
      return &instance;
   }
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const forward_list<string>*)
   {
      ...
      ::ROOT::AddClassAlternate("forward_list<string>","std::forward_list<std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >, std::allocator<std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const forward_list<long>*)
   {
      ...
      ::ROOT::AddClassAlternate("forward_list<long>","std::forward_list<long, std::allocator<long> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const forward_list<int>*)
   {
      ...
      ::ROOT::AddClassAlternate("forward_list<int>","std::forward_list<int, std::allocator<int> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const forward_list<float>*)
   {
      ...
      ::ROOT::AddClassAlternate("forward_list<float>","std::forward_list<float, std::allocator<float> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const forward_list<double>*)
   {
      ...
      ::ROOT::AddClassAlternate("forward_list<double>","std::forward_list<double, std::allocator<double> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const forward_list<char*>*)
   {
      ...
      ::ROOT::AddClassAlternate("forward_list<char*>","std::forward_list<char*, std::allocator<char*> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libforward_listDict",
        ...
        TriggerDictionaryInitialization_libforward_listDict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
