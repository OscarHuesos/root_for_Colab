...
#define R__DICTIONARY_FILENAME G__map2Dict
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<long,void*>*)
   {
      ...
      ::ROOT::AddClassAlternate("map<long,void*>","std::map<long, void*, std::less<long>, std::allocator<std::pair<long const, void*> > >");
      return &instance;
   }
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<long,long>*)
   {
      ...
      ::ROOT::AddClassAlternate("map<long,long>","std::map<long, long, std::less<long>, std::allocator<std::pair<long const, long> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<long,int>*)
   {
      ...
      ::ROOT::AddClassAlternate("map<long,int>","std::map<long, int, std::less<long>, std::allocator<std::pair<long const, int> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<long,float>*)
   {
      ...
      ::ROOT::AddClassAlternate("map<long,float>","std::map<long, float, std::less<long>, std::allocator<std::pair<long const, float> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<long,double>*)
   {
      ...
      ::ROOT::AddClassAlternate("map<long,double>","std::map<long, double, std::less<long>, std::allocator<std::pair<long const, double> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<long,char*>*)
   {
      ...
      ::ROOT::AddClassAlternate("map<long,char*>","std::map<long, char*, std::less<long>, std::allocator<std::pair<long const, char*> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<double,void*>*)
   {
      ...
      ::ROOT::AddClassAlternate("map<double,void*>","std::map<double, void*, std::less<double>, std::allocator<std::pair<double const, void*> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<double,long>*)
   {
      ...
      ::ROOT::AddClassAlternate("map<double,long>","std::map<double, long, std::less<double>, std::allocator<std::pair<double const, long> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<double,float>*)
   {
      ...
      ::ROOT::AddClassAlternate("map<double,float>","std::map<double, float, std::less<double>, std::allocator<std::pair<double const, float> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<double,char*>*)
   {
      ...
      ::ROOT::AddClassAlternate("map<double,char*>","std::map<double, char*, std::less<double>, std::allocator<std::pair<double const, char*> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libmap2Dict",
        ...
        TriggerDictionaryInitialization_libmap2Dict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
