...
#define R__DICTIONARY_FILENAME G__mapDict
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<string,void*>*)
   {
      ...
      ::ROOT::AddClassAlternate("map<string,void*>","std::map<std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >, void*, std::less<std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > >, std::allocator<std::pair<std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > const, void*> > >");
      return &instance;
   }
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<string,long>*)
   {
      ...
      ::ROOT::AddClassAlternate("map<string,long>","std::map<std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >, long, std::less<std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > >, std::allocator<std::pair<std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > const, long> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<char*,void*>*)
   {
      ...
      ::ROOT::AddClassAlternate("map<char*,void*>","std::map<char*, void*, std::less<char*>, std::allocator<std::pair<char* const, void*> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<char*,long>*)
   {
      ...
      ::ROOT::AddClassAlternate("map<char*,long>","std::map<char*, long, std::less<char*>, std::allocator<std::pair<char* const, long> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<char*,int>*)
   {
      ...
      ::ROOT::AddClassAlternate("map<char*,int>","std::map<char*, int, std::less<char*>, std::allocator<std::pair<char* const, int> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<char*,float>*)
   {
      ...
      ::ROOT::AddClassAlternate("map<char*,float>","std::map<char*, float, std::less<char*>, std::allocator<std::pair<char* const, float> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<char*,double>*)
   {
      ...
      ::ROOT::AddClassAlternate("map<char*,double>","std::map<char*, double, std::less<char*>, std::allocator<std::pair<char* const, double> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<char*,char*>*)
   {
      ...
      ::ROOT::AddClassAlternate("map<char*,char*>","std::map<char*, char*, std::less<char*>, std::allocator<std::pair<char* const, char*> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libmapDict",
        ...
        TriggerDictionaryInitialization_libmapDict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
