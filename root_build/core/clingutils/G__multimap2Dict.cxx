...
#define R__DICTIONARY_FILENAME G__multimap2Dict
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const multimap<long,void*>*)
   {
      ...
      ::ROOT::AddClassAlternate("multimap<long,void*>","std::multimap<long, void*, std::less<long>, std::allocator<std::pair<long const, void*> > >");
      return &instance;
   }
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const multimap<long,long>*)
   {
      ...
      ::ROOT::AddClassAlternate("multimap<long,long>","std::multimap<long, long, std::less<long>, std::allocator<std::pair<long const, long> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const multimap<long,int>*)
   {
      ...
      ::ROOT::AddClassAlternate("multimap<long,int>","std::multimap<long, int, std::less<long>, std::allocator<std::pair<long const, int> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const multimap<long,double>*)
   {
      ...
      ::ROOT::AddClassAlternate("multimap<long,double>","std::multimap<long, double, std::less<long>, std::allocator<std::pair<long const, double> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const multimap<long,char*>*)
   {
      ...
      ::ROOT::AddClassAlternate("multimap<long,char*>","std::multimap<long, char*, std::less<long>, std::allocator<std::pair<long const, char*> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const multimap<double,void*>*)
   {
      ...
      ::ROOT::AddClassAlternate("multimap<double,void*>","std::multimap<double, void*, std::less<double>, std::allocator<std::pair<double const, void*> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const multimap<double,long>*)
   {
      ...
      ::ROOT::AddClassAlternate("multimap<double,long>","std::multimap<double, long, std::less<double>, std::allocator<std::pair<double const, long> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const multimap<double,int>*)
   {
      ...
      ::ROOT::AddClassAlternate("multimap<double,int>","std::multimap<double, int, std::less<double>, std::allocator<std::pair<double const, int> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const multimap<double,double>*)
   {
      ...
      ::ROOT::AddClassAlternate("multimap<double,double>","std::multimap<double, double, std::less<double>, std::allocator<std::pair<double const, double> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const multimap<double,char*>*)
   {
      ...
      ::ROOT::AddClassAlternate("multimap<double,char*>","std::multimap<double, char*, std::less<double>, std::allocator<std::pair<double const, char*> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libmultimap2Dict",
        ...
        TriggerDictionaryInitialization_libmultimap2Dict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
