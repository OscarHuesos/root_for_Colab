...
#define R__DICTIONARY_FILENAME G__unordered_setDict
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const unordered_set<void*>*)
   {
      ...
      ::ROOT::AddClassAlternate("unordered_set<void*>","std::unordered_set<void*, std::hash<void*>, std::equal_to<void*>, std::allocator<void*> >");
      return &instance;
   }
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const unordered_set<long>*)
   {
      ...
      ::ROOT::AddClassAlternate("unordered_set<long>","std::unordered_set<long, std::hash<long>, std::equal_to<long>, std::allocator<long> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const unordered_set<float>*)
   {
      ...
      ::ROOT::AddClassAlternate("unordered_set<float>","std::unordered_set<float, std::hash<float>, std::equal_to<float>, std::allocator<float> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const unordered_set<double>*)
   {
      ...
      ::ROOT::AddClassAlternate("unordered_set<double>","std::unordered_set<double, std::hash<double>, std::equal_to<double>, std::allocator<double> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const unordered_set<char*>*)
   {
      ...
      ::ROOT::AddClassAlternate("unordered_set<char*>","std::unordered_set<char*, std::hash<char*>, std::equal_to<char*>, std::allocator<char*> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libunordered_setDict",
        ...
        TriggerDictionaryInitialization_libunordered_setDict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
