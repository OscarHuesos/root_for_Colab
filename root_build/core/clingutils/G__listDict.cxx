...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const list<void*>*)
   {
      ...
      ::ROOT::AddClassAlternate("list<void*>","std::__cxx11::list<void*, std::allocator<void*> >");
      return &instance;
   }
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const list<long>*)
   {
      ...
      ::ROOT::AddClassAlternate("list<long>","std::__cxx11::list<long, std::allocator<long> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const list<float>*)
   {
      ...
      ::ROOT::AddClassAlternate("list<float>","std::__cxx11::list<float, std::allocator<float> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const list<double>*)
   {
      ...
      ::ROOT::AddClassAlternate("list<double>","std::__cxx11::list<double, std::allocator<double> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const list<char*>*)
   {
      ...
      ::ROOT::AddClassAlternate("list<char*>","std::__cxx11::list<char*, std::allocator<char*> >");
      return &instance;
   }
   // Static variable to force the class initialization
