   ...
   namespace ROOT {
      ...
      inline ::ROOT::TGenericClassInfo *GenerateInitInstance()
      {
         static ::ROOT::TGenericClassInfo 
            instance("TMVA", 0 /*version*/, "TMVA/Types.h", 49,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TMVA::StatDialogBDT*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TMVA::StatDialogBDT", "TMVA/BDT.h", 50,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TMVA::StatDialogBDTReg*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TMVA::StatDialogBDTReg", "TMVA/BDT_Reg.h", 39,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TMVA::MethodInfo*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TMVA::MethodInfo", ::TMVA::MethodInfo::Class_Version(), "TMVA/mvaeffs.h", 25,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TMVA::StatDialogMVAEffs*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TMVA::StatDialogMVAEffs", "TMVA/mvaeffs.h", 71,
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TMVA::MethodInfo*)0x0)->GetClass(); }
   return fgIsA;
}
