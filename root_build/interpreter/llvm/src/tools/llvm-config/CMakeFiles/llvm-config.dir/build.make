...
interpreter/llvm/src/tools/llvm-config/CMakeFiles/llvm-config.dir/llvm-config.cpp.o: interpreter/llvm/src/tools/llvm-config/BuildVariables.inc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/content/root_src/root_build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object interpreter/llvm/src/tools/llvm-config/CMakeFiles/llvm-config.dir/llvm-config.cpp.o"
	cd /content/root_src/root_build/interpreter/llvm/src/tools/llvm-config && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/llvm-config.dir/llvm-config.cpp.o -c /content/root_src/interpreter/llvm/src/tools/llvm-config/llvm-config.cpp
...
interpreter/llvm/src/tools/llvm-config/CMakeFiles/llvm-config.dir/llvm-config.cpp.i: cmake_force
	...
	cd /content/root_src/root_build/interpreter/llvm/src/tools/llvm-config && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /content/root_src/interpreter/llvm/src/tools/llvm-config/llvm-config.cpp > CMakeFiles/llvm-config.dir/llvm-config.cpp.i
...
interpreter/llvm/src/tools/llvm-config/CMakeFiles/llvm-config.dir/llvm-config.cpp.s: cmake_force
	...
	cd /content/root_src/root_build/interpreter/llvm/src/tools/llvm-config && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /content/root_src/interpreter/llvm/src/tools/llvm-config/llvm-config.cpp -o CMakeFiles/llvm-config.dir/llvm-config.cpp.s
...
interpreter/llvm/src/bin/llvm-config: /usr/lib/x86_64-linux-gnu/libz.so
interpreter/llvm/src/bin/llvm-config: interpreter/llvm/src/lib/libLLVMDemangle.a
interpreter/llvm/src/bin/llvm-config: interpreter/llvm/src/tools/llvm-config/CMakeFiles/llvm-config.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/content/root_src/root_build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/llvm-config"
	cd /content/root_src/root_build/interpreter/llvm/src/tools/llvm-config && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/llvm-config.dir/link.txt --verbose=$(VERBOSE)
...
interpreter/llvm/src/tools/llvm-config/CMakeFiles/llvm-config.dir/clean:
	cd /content/root_src/root_build/interpreter/llvm/src/tools/llvm-config && $(CMAKE_COMMAND) -P CMakeFiles/llvm-config.dir/cmake_clean.cmake
...
interpreter/llvm/src/tools/llvm-config/CMakeFiles/llvm-config.dir/depend:
	cd /content/root_src/root_build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /content/root_src /content/root_src/interpreter/llvm/src/tools/llvm-config /content/root_src/root_build /content/root_src/root_build/interpreter/llvm/src/tools/llvm-config /content/root_src/root_build/interpreter/llvm/src/tools/llvm-config/CMakeFiles/llvm-config.dir/DependInfo.cmake --color=$(COLOR)
