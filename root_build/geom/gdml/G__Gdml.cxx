...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TGDMLRefl*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TGDMLRefl", ::TGDMLRefl::Class_Version(), "TGDMLParse.h", 29,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TGDMLParse*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TGDMLParse", ::TGDMLParse::Class_Version(), "TGDMLParse.h", 94,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TGDMLWrite*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TGDMLWrite", ::TGDMLWrite::Class_Version(), "TGDMLWrite.h", 55,
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TGDMLRefl*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TGDMLParse*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TGDMLWrite*)0x0)->GetClass(); }
   return fgIsA;
}
