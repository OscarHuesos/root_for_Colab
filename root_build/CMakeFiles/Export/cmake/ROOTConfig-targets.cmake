...
set_target_properties(ROOT::cppyy3_6 PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "/usr/include/python3.6m"
  INTERFACE_LINK_LIBRARIES "-Wl,--unresolved-symbols=ignore-all;ROOT::cppyy_backend3_6"
)

# Create imported target ROOT::ROOTPythonizations3_6
add_library(ROOT::ROOTPythonizations3_6 SHARED IMPORTED)

set_target_properties(ROOT::ROOTPythonizations3_6 PROPERTIES
  INTERFACE_LINK_LIBRARIES "-Wl,--unresolved-symbols=ignore-all;ROOT::Core;ROOT::Tree;ROOT::cppyy3_6"
)
...
set_target_properties(ROOT::PyROOT3 PROPERTIES
  INTERFACE_LINK_LIBRARIES "ROOT::cppyy_backend3_6;ROOT::cppyy3_6;ROOT::ROOTPythonizations3_6"
)
...
# Create imported target ROOT::JupyROOT3_6
add_library(ROOT::JupyROOT3_6 SHARED IMPORTED)
