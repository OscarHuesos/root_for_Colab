...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::ROOT::Math::SMatrix<Double32_t,3,3,ROOT::Math::MatRepSym<Double32_t,3> >*)
   {
      ...
      std::vector<ROOT::Internal::TSchemaHelper> readrules(3);
      rule = &readrules[0];
      rule->fSourceClass = "ROOT::Math::SMatrix<double,3,3,ROOT::Math::MatRepSym<double,3> >";
      rule->fTarget      = "";
      rule->fVersion     = "[1-]";
      rule = &readrules[1];
      rule->fSourceClass = "ROOT::Math::SMatrix<float,3,3,ROOT::Math::MatRepSym<float,3> >";
      rule->fTarget      = "";
      rule->fVersion     = "[1-]";
      rule = &readrules[2];
      rule->fSourceClass = "ROOT::Math::SMatrix<Float16_t,3,3,ROOT::Math::MatRepSym<Float16_t,3> >";
      rule->fTarget      = "";
      rule->fVersion     = "[1-]";
      instance.SetReadRules( readrules );
      return &instance;
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::ROOT::Math::SMatrix<Double32_t,4,4,ROOT::Math::MatRepSym<Double32_t,4> >*)
   {
      ...
      std::vector<ROOT::Internal::TSchemaHelper> readrules(3);
      rule = &readrules[0];
      rule->fSourceClass = "ROOT::Math::SMatrix<double,4,4,ROOT::Math::MatRepSym<double,4> >";
      rule->fTarget      = "";
      rule->fVersion     = "[1-]";
      rule = &readrules[1];
      rule->fSourceClass = "ROOT::Math::SMatrix<float,4,4,ROOT::Math::MatRepSym<float,4> >";
      rule->fTarget      = "";
      rule->fVersion     = "[1-]";
      rule = &readrules[2];
      rule->fSourceClass = "ROOT::Math::SMatrix<Float16_t,4,4,ROOT::Math::MatRepSym<Float16_t,4> >";
      rule->fTarget      = "";
      rule->fVersion     = "[1-]";
      instance.SetReadRules( readrules );
      return &instance;
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::ROOT::Math::SMatrix<Double32_t,5,5,ROOT::Math::MatRepSym<Double32_t,5> >*)
   {
      ...
      std::vector<ROOT::Internal::TSchemaHelper> readrules(3);
      rule = &readrules[0];
      rule->fSourceClass = "ROOT::Math::SMatrix<double,5,5,ROOT::Math::MatRepSym<double,5> >";
      rule->fTarget      = "";
      rule->fVersion     = "[1-]";
      rule = &readrules[1];
      rule->fSourceClass = "ROOT::Math::SMatrix<float,5,5,ROOT::Math::MatRepSym<float,5> >";
      rule->fTarget      = "";
      rule->fVersion     = "[1-]";
      rule = &readrules[2];
      rule->fSourceClass = "ROOT::Math::SMatrix<Float16_t,5,5,ROOT::Math::MatRepSym<Float16_t,5> >";
      rule->fTarget      = "";
      rule->fVersion     = "[1-]";
      instance.SetReadRules( readrules );
      return &instance;
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::ROOT::Math::SMatrix<Double32_t,6,6,ROOT::Math::MatRepSym<Double32_t,6> >*)
   {
      ...
      std::vector<ROOT::Internal::TSchemaHelper> readrules(3);
      rule = &readrules[0];
      rule->fSourceClass = "ROOT::Math::SMatrix<double,6,6,ROOT::Math::MatRepSym<double,6> >";
      rule->fTarget      = "";
      rule->fVersion     = "[1-]";
      rule = &readrules[1];
      rule->fSourceClass = "ROOT::Math::SMatrix<float,6,6,ROOT::Math::MatRepSym<float,6> >";
      rule->fTarget      = "";
      rule->fVersion     = "[1-]";
      rule = &readrules[2];
      rule->fSourceClass = "ROOT::Math::SMatrix<Float16_t,6,6,ROOT::Math::MatRepSym<Float16_t,6> >";
      rule->fTarget      = "";
      rule->fVersion     = "[1-]";
      instance.SetReadRules( readrules );
      return &instance;
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libSmatrix_G__Smatrix32",
        ...
        TriggerDictionaryInitialization_libSmatrix_G__Smatrix32_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
